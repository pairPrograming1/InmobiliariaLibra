...
function PropertyForm({ property, onSubmit }) {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            if (response.ok) {
                // Success alert
                await __TURBOPACK__imported__module__$5b$project$5d2f$proyectos$2f$InmobiliariaLibra$2f$node_modules$2f$sweetalert2$2f$dist$2f$sweetalert2$2e$all$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].fire({
...
_s(PropertyForm, "JuYeDfuMAd7Q3o8AxsCfPbzWEwE=", false, function() {
    return [
